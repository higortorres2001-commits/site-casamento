...
import { handleUserManagement } from 'shared/user.service.ts';
import { validateRequestData, validateProducts, applyCoupon, createOrder } from 'shared/order.service.ts';
import { processPixPayment, processCreditCardPayment } from 'shared/asaas.service.ts';
